            ...
            <header className="">
                <div className="mx-auto sm:px-7 px-4 max-w-screen-xl py-10">
                    ...
                    >
                        ...
                        <div
                            onClick={toggleMenu}
                            className={`sidebar-toggle cursor-pointer block md:hidden ${
                                isMenuOpen ? "open" : ""
                            }`}
                        >
                            <span></span>
                ...
                <div className="max-w-screen-xl sm:px-7 px-4 py-10 lg:py-20 mx-auto">
                    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
                        <div className="flex flex-col sm:flex-row items-center  sm:col-span-2 md:col-span-3">
                            <div className="flex-none mb-10 sm:mb-0">
                                <a className="text-2xl font-semibold" href="/">
                                    <img
                                        className="object-contain h-[80px] w-[200px]"
                                        src={
                                            siteLogo
                                                ? `/storage/${siteLogo}`
                                                : logo
                            ...
                            <div className="flex-1">
                                ...
                                <div className="mt-5 space-y-2">
                                    <p className="text-sm text-gray-600">
                                        {siteName} is the official online
                                        platform for conducting the elections of
                                        the Alliance Youth of the Philippines –
                                        North Central Mindanao District. This
                                        site provides a secure, transparent, and
                                        accessible way for members to cast their
                                        votes and participate in choosing
                                        servant leaders who embody humility,
                                        integrity, and Christ-like service. The
                                        system ensures that every vote counts
                                        toward building a future led with
                                        compassion, faith, and dedication to
                                        ministry.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between">
                        ...
                        <div className="flex flex-row items-start mt-0 md:mt-5 space-y-2 order-1 md:order-2">
                            <a
                                href="/privacy-policy"
                                className="text-black text-sm hover:underline hover:text-blue-600 mx-2"
                            >
                                Privacy Policy
                            </a>{" "}
                            |
