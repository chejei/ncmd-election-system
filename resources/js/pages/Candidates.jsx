    ...
    <>
        <section 
            ...
            <div className="h-[200px]  mx-auto sm:px-7 px-4 max-w-screen-xl flex items-center"> 
                <h1 className="text-5xl text-white font-bold">Our Election Candidates</h1> 
            </div>
        </section>
                 ...
                 {positions
                    ...
                    <h2 className="text-3xl font-semibold mb-4">{pos.title}</h2>
                        ...
                        {pos.candidates.map((cand) => (
                            ...
                            >
                                <img
                                src={cand.photo ? `/storage/${cand.photo}` : "/images/user-placeholder.png"}
                                alt={cand.first_name}
                                ...
                                <a href={`candidate/${cand.slug}`} className="inline-flex items-center text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-3xl text-sm px-5 py-2.5 me-2 mb-2">
                                    Read more
                                    <ReadMoreIcon />
                                </a>
                            </div>
