...
export default function Home() {
    ...
    return (
        <>
                        ...
                        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                            <div>
                                ...
                                <p className="mt-2 text-gray-500">
                                    ...
                                    Putting the needs of others above personal
                                    ambition. A servant leader listens,
                                    supports, and uplifts the community,
                                    following Christ's example of washing His
                                    disciples' feet. Service is not secondary to
                                    leadership—it is the foundation of it.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-gray-500">
                                    Guiding others with empathy, kindness, and
                                    understanding. A compassionate leader values
                                    people over power, showing patience and love
                                    in decision-making and ensuring that every
                                    voice is heard.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-gray-500">
                                    Faith is the compass of a servant leader.
                                    Leading in alignment with God’s Word,
                                    trusting His wisdom above all. It is about
                                    inspiring others to remain steadfast in
                                    their spiritual journey, ensuring that every
                                    action and decision reflects Christ-centered
                                    values.
                                </p>
                            </div>
                        </div>
            ...
            <section
                id="image"
                className="bg-gradient-to-b from-black to-slate-950  bg-black overlay-wrapper"
            >
                <div className="max-w-screen-xl sm:px-7 px-4 py-10 lg:py-20 mx-auto overlay-text">
                    <div className="p-10 md:p-15 lg:p-20 bg-opacity rounded-lg">
                        ...
                        <p className="text-gray-600 pt-4 pb-6 text-[18px] leading-[24px] md:text-[20px] md:leading-[26px]">
                            ...
                            builds a stronger future for NCMD.
                        </p>
                        <a
                            href="/candidates"
                    ...
                    <ol className="list-decimal guidelines-list sm:px-7 px-4">
                        <li>
                            ...
                            <ul className="list-disc">
                                <li>
                                    Only duly registered and verified members
                                ...
                                <li>
                                    Voter credentials (PIN or unique code) are
                        ...
                        <li>
                            ...
                            <ul className="list-disc">
                                ...
                                <li>
                                    If you encounter login issues, contact the
                        ...
                        <li>
                            ...
                            <ul className="list-disc">
                                <li>
                                    After logging in, you will be directed to a
                                    Welcome Page
                                </li>
                                <li>
                                    Click Start Voting to proceed to the ballot
                                    form
                                </li>
                                <li>
                                    Step 1: Fill Out Your Ballot Form – choose
                                    your preferred candidate for each position
                                </li>
                                <li>
                                    Step 2: Review Your Ballot – a summary table
                                    will show all the candidates you have
                                    selected
                                </li>
                                <li>
                                    Final Step: Capture Your Photo – take a
                                    photo for identity verification to ensure
                                    election integrity and prevent fraud
                                </li>
                                <li>
                                    Click Submit Ballot to finalize your vote
                                </li>
                                <li>
                                    You will be redirected to a Thank You Page
                                    confirming that your vote has been
                                    successfully recorded
                                </li>
                            </ul>
                            <p className="italic">
                                Note: Once submitted, ballots cannot be edited
                                or resubmitted.
                            </p>
                        </li>
                        <li>
                            ...
                            <ul className="list-disc">
                                <li>
                                    The election system will open on:{" "}
                                    {startDate || "TBA"}
                                </li>
                                <li>
                                    The election system will close on:{" "}
                                    {endDate || "TBA"}
                                </li>
                                <li>
                                    Votes cast outside this period will not be
                                    counted.
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul className="list-disc">
                                <li>
                                    All votes are anonymous and securely
                                    recorded.
                                </li>
                                <li>
                                    The election committee will oversee and
                                    validate results to ensure fairness and
                                    transparency.
                                </li>
                                <li>
                                    Any attempt to manipulate or compromise the
                                    system will result in disqualification and
                        ...
                        <li>
                            ...
                            <ul className="list-disc">
                                <li>
                                    Results will be tabulated automatically
                                    after the voting period ends.
                                </li>
                                <li>
                                    Official winners will be announced by the
                                    NCMD Election Committee through the site and
                        ...
                        <li>
                            ...
                            <p>
                                {" "}
                                "Electing Servant Leaders – Serve First, Lead
                                with Compassion, Guide with Faith."
                            </p>
                            <p>
                                Every vote is a prayerful choice to raise
                                leaders who embody humility, integrity, and
                                Christ-like service.{" "}
                            </p>
                        </li>
                    </ol>
