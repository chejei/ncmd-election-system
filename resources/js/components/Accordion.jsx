    ...
    return (
        <div className="w-full md:px-6">
            <div className="flex justify-between items-center w-full">
                ...
                >
                    <CaretIcon  className={`w-8 h-8 transform transition-transform ${
                        open ? "rotate-180" : ""
                        }`} />
                </button>
            </div>
            {open && (
                <div className="mt-6 w-full">
                    <div className="text-base leading-6 text-gray-600 font-normal editor-html" dangerouslySetInnerHTML={{ __html: content }}></div>
                </div>
            )}
        </div>
    );
